...
HintRule = getattr(_impl, "HintRule")
BIDS_HINTS = getattr(_impl, "BIDS_HINTS")
DEFAULT_BIDS_HINTS = getattr(_impl, "DEFAULT_BIDS_HINTS")
override_hint_patterns = getattr(_impl, "override_hint_patterns")
restore_default_hint_patterns = getattr(_impl, "restore_default_hint_patterns")
