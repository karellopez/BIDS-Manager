"""Main application window wiring for the BIDS Manager GUI."""
...
from PyQt5.QtWidgets import QApplication, QDialog, QHBoxLayout, QLabel, QMainWindow, QMenu, QPushButton, QTabWidget, QVBoxLayout, QWidget

from bids_manager import dicom_inventory
from bids_manager.schema_renamer import DEFAULT_SCHEMA_DIR, ENABLE_SCHEMA_RENAMER, load_bids_schema
from bids_manager.GUI.common import ICON_FILE, LOGO_FILE, PREF_DIR
from bids_manager.GUI.converter import (
    AuthorshipDialog,
    ConverterMixin,
    CpuSettingsDialog,
    DpiSettingsDialog,
    _ConflictScannerWorker,
)
from bids_manager.GUI.editor import EditorMixin


class BIDSManager(ConverterMixin, EditorMixin, QMainWindow):
    """Main GUI window coordinating converter and editor tabs."""
