"""Main window wiring for the BIDS Manager GUI.

This module composes the converter and editor submodules into the unified GUI
application while keeping shared window-level concerns (themes, DPI, status
controls)."""
...
class BIDSManager(ConverterMixin, EditorMixin, QMainWindow):
    """Main GUI for BIDS Manager joining converter and editor tabs."""
